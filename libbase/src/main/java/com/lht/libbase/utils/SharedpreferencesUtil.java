...
//----------------设置数据-----------------------
    ...
    public void setBitmap(String key,Bitmap bitmap,Bitmap.CompressFormat type,int quality){
        ...
        String picBase64=new String(Base64.encode(byteArrayOutputStream.toByteArray(),Base64.DEFAULT));
    ...
    public Object getEntity(String key){
        ...
        //读取字节
        byte[] base64 = Base64.decode(obj_Base64.getBytes(),Base64.DEFAULT);
        //**********封装到字节流
    ...
    public Bitmap getBitmap(String key){
        ...
        byte[] base64 = Base64.decode(pic_Base64.getBytes(),Base64.DEFAULT);
