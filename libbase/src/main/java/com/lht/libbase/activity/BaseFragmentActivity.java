...
public class BaseFragmentActivity extends BaseActivity {
    ...
    private void setLayout(int layoutID){
        ...
        fragmentLayout = findViewById(frameId);

        tabHost = findViewById(tabHostId);
    }
    ...
    protected View getIndicator(int i){
        ...
        View view;
        if(specIndicator == -1){
            specIndicator = R.layout.activity_fragments_view_tabspec;
            specImgId = R.id.img;
        ...
        badgeRel = view.findViewById(specBadgeRelId);

        img = view.findViewById(specImgId);

        text = view.findViewById(specTextId);
